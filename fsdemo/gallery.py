from flask import Blueprint, request, redirect, render_template, url_for, current_app, g
...
def gallery_do_upload():
    ...
    if 'photo' in request.files:
        try:
            ...
            gitem = GalleryMiddleware(itemlink = photos.url(filename), \
            ...
            res.resMsg = 'Error: Upload failed.\n\n' + \
                ...
                '{0}'.format(current_app.config['MAX_CONTENT_LENGTH']/(1024*1024)) +' MB].'
            pass
